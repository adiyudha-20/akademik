      ...
      <table class="table table-striped">
          ...
          ?>
            ...
            <tr>
              ...
              <td>
               <a class="btn btn-secondary btn-sm" href="?gu=edit_guru&nip=<?php echo $m['nip'];?>"><i class="fa fa-pencil">Edit</i></a>  
               <a class="btn btn-danger btn-sm" href="?gu=delete_guru&nip=<?php echo $m['nip'];?>"><i class="fa fa-trash-o">Delete</i></a>
              </td>
            </tr>
